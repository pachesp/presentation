...
\newcommand{\PersonTitel}{B.Sc.}
\newcommand{\PersonVorname}{Francisco}
\newcommand{\PersonNachname}{Espinosa}
...
% Fakultät:
\newcommand{\FakultaetName}{\footnotesize Department of Informatics}
\newcommand{\LehrstuhlName}{\footnotesize Chair of Scientific Computing in Computer Science}
