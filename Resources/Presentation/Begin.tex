...
\input{./Resources/_Information.tex}
...
\newcommand{\PraesentationTitelseiteInhalt}{
    \begin{textblock*}{\paperwidth}[0,0](0cm,-\PraesentationSeitenrand - 6.5mm + \PraesentationPositionKorrekturOben)%
        \color{PraesentationTextfarbe}
        \frametitle{\\\vspace{0.1cm}\inserttitle\\[0.35cm]\large\insertsubtitle}
        \vspace*{4cm}
        \usebeamerfont{author}\selectfont\vspace{4cm}\insertauthor\\
        %\insertinstitute\\
        \vspace{1.5cm}
        \insertdate%
    \end{textblock*}
...
\newcommand{\PraesentationBildUhrenturm}{%
    \begin{textblock*}{10.82cm}[1,1](\paperwidth - \PraesentationSeitenrand - \PraesentationSeitenrand, \paperheight - 9mm)%
        \includegraphics{./Resources/Presentation/Images/TUM_Uhrenturm.png}%
    \end{textblock*}%
}

\newcommand{\PraesentationStartseiteUhrenturm}{
    \setbeamertemplate{title page}{%
        \PraesentationSeitenkopfInhalt{./Resources/Images/Universitaet_Logo_RGB.pdf}
...
\newcommand{\PraesentationStartseiteFlaggen}{
    \setbeamertemplate{title page}{%
        \begin{textblock*}{\paperwidth}[0,1](-\PraesentationSeitenrand,\paperheight-\PraesentationSeitenrand)%
            \includegraphics[width=\paperwidth]{./Resources/Presentation/Images/Universitaet_Flaggen.jpg}%
        \end{textblock*}
        \PraesentationSeitenkopfInhalt{./Resources/Images/Universitaet_Logo_weiss.pdf}
        \PraesentationTitelseiteInhalt
    }
}
