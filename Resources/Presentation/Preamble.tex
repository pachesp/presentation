...
%% TUM COLORS
\definecolor{TUMDarkBlue}{RGB}{0 101 189} %x#0065bd
...
\newcommand{\hthD}{h_{\Gamma_{3D}}}
\newcommand{\htwD}{h_{\Gamma_{2D}}}
\newcommand{\uthD}{\mathbf{u}_{\Gamma_{3D}}}
\newcommand{\utwD}{\mathbf{u}_{\Gamma_{2D}}}
\newcommand{\pthD}{p_{\Gamma_{3D}}}
\newcommand{\qtwD}{q_{\Gamma_{2D}}}
\newcommand{\qthD}{q_{\Gamma_{3D}}}
